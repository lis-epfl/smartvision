...
static int8_t SmartVision_V1_Init     (void);
static int8_t SmartVision_V1_DeInit   (void);
static int8_t SmartVision_V1_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t SmartVision_V1_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_SmartVision_V1_fops = 
{
  SmartVision_V1_Init,
  SmartVision_V1_DeInit,
  SmartVision_V1_Control,
  SmartVision_V1_Receive
};
...
/**
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t SmartVision_V1_Receive(uint8_t* Buf, uint32_t *Len)
{
